...
import (
	...
	m "github.com/banbanpeppa/itchat-go/model"
	s "github.com/banbanpeppa/itchat-go/service"

	e "github.com/banbanpeppa/itchat-go/enum"
...
func TestItchat(testing *testing.T) {
	/* 从微信服务器获取UUID */
	...
	for {
		...
		if err != nil {
			...
			printErr(err)
			if retcode == 1101 { //手机点击了退出网页版微信或者在别处登录了微信
